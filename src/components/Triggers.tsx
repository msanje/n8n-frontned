...
function Triggers({
  ...
  return (
    <div
      className={`absolute top-0 px-4 py-4 right-0 h-screen w-[450px] bg-white dark:bg-gray-400 shadow-lg transform transition-transform duration-200 overflow-auto overflow-x-hidden ${open ? "translate-x-0" : "translate-x-full"}`}
    >
